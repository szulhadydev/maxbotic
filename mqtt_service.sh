...
export MQTT_BROKER="${MQTT_BROKER:-xx.xxxx.xxxx}"
export MQTT_PORT="${MQTT_PORT:-1883}"
export MQTT_CLIENT_ID="${MQTT_CLIENT_ID:-CM4-01}"
export MQTT_TOPIC="${MQTT_TOPIC:-EA/data/CM4-01}"
export MQTT_TOPIC_SIREN_PATTERN="${MQTT_TOPIC_SIREN_PATTERN:-EA/${MQTT_CLIENT_ID}/siren/pattern}"
...
export MQTT_ALERT_ON_INTERVAL_TOPIC="${MQTT_ALERT_ON_INTERVAL_TOPIC:-EA/${MQTT_CLIENT_ID}/alerton/set}"
export MQTT_ALERT_OFF_INTERVAL_TOPIC="${MQTT_ALERT_OFF_INTERVAL_TOPIC:-EA/${MQTT_CLIENT_ID}/alertoff/set}"
export MQTT_ALERT_GAP_TOPIC="${MQTT_ALERT_GAP_TOPIC:-EA/${MQTT_CLIENT_ID}/alertgap/set}"
export MQTT_ALERT_CYCLE_TOPIC="${MQTT_ALERT_CYCLE_TOPIC:-EA/${MQTT_CLIENT_ID}/alertcycle/set}"

export MQTT_WARNING_ON_INTERVAL_TOPIC="${MQTT_WARNING_ON_INTERVAL_TOPIC:-EA/${MQTT_CLIENT_ID}/warningon/set}"
export MQTT_WARNING_OFF_INTERVAL_TOPIC="${MQTT_WARNING_OFF_INTERVAL_TOPIC:-EA/${MQTT_CLIENT_ID}/warningoff/set}"
export MQTT_WARNING_GAP_TOPIC="${MQTT_WARNING_GAP_TOPIC:-EA/${MQTT_CLIENT_ID}/warninggap/set}"
export MQTT_WARNING_CYCLE_TOPIC="${MQTT_WARNING_CYCLE_TOPIC:-EA/${MQTT_CLIENT_ID}/warningcycle/set}"
